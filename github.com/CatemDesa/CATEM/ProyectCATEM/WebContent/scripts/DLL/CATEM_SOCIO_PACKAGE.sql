...
create or replace package body CATEM_SOCIO_PACKAGE as
  ...
  BEGIN 
    ...
    INSERT INTO SOCIO(IDSOCIO,apellido, nombre, NUMERO_SOCIO, idTipoSocio, nacionalidad, IdEstadoCivil, FECHA_NAC, dni, ocupacion, mail, aFavor) 
    VALUES (ID_SOCIO,apellido, nombre, nroSocio, idTipoSocio, nacionalidad, idEstadoCivil, fechaNac, dni, ocupacion, email, aFavor);
    RETURN ID_SOCIO;
  END FN_INSERT_SOCIO;
